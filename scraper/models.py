...
class UserProfile(models.Model):
    ...
    meta_token = models.TextField(blank=True, help_text="Meta token for Facebook/Threads")
    meta_user_id = models.CharField(max_length=100, blank=True, help_text="Meta User ID/Page ID for posting")

    telegram_bot_token = models.CharField(max_length=100, blank=True, help_text="Telegram bot token for sending messages")
    telegram_chat_id = models.CharField(max_length=255, blank=True, help_text="Comma-separated list of chat IDs")
...
class ScrapedContent(models.Model):
    ...
    telegram_post_count = models.IntegerField(default=0)
